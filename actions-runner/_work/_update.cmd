...
set rootfolder=C:\Users\LENOVO\Desktop\Internship\Task 6\actions-runner
set existrunnerversion=2.327.1
set downloadrunnerversion=2.328.0
set logfile=C:\Users\LENOVO\Desktop\Internship\Task 6\actions-runner\_diag\SelfUpdate-20250815-133043.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Users\LENOVO\Desktop\Internship\Task 6\actions-runner\run.cmd"
) else (
  endlocal
)
